    ...
    <footer className="footer">
                ...
                <Row>
                    <Col lg="4" md="4" sm="6">
                      <div className="logo">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quibusdam consectetur, aut voluptates quasi quae sapiente.</p>
                      </div>
                    </Col>
                    <Col lg="3" md="4" sm='6'>
        ...
        <div className="footer__bottom">
          <Container>
            <Row>
              <Col lg='12'>
                <p>copyright 2023, developed by Tanzeem Khan. All rights reserved</p>
              </Col>
            </Row>
          </Container>
        </div>
